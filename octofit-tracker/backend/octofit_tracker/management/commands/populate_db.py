...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(user=steve, type='swim', duration=45, date=date(2023, 1, 2))
        Activity.objects.create(user=bruce, type='cycle', duration=60, date=date(2023, 1, 3))
